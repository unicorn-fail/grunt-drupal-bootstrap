...
(function (exports) {
  ...
  Preprocessor.prototype.formatError = function (e) {
    var file = path.resolve(e.file || e.filename);
    file += e.line !== void 0 ? (':' + e.line) : '';
    file += e.column !== void 0 ? (':' + e.column) : '';
    return file.yellow + grunt.util.linefeed + e.message.red + grunt.util.linefeed;
  };
